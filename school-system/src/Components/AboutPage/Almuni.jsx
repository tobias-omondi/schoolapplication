  ...
  return (
    <div>
      ...
      <div  className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 p-5 ">
        ...
        />
        <h2 className="mt-3 text-lg font-medium text-center  text-gray-700 lg:text-2xl">{alumni.name}</h2>
        <p className="text-gray-600 text-center lg:text-xl font-extralight p-5">{alumni.occupation}</p>
      </div>
