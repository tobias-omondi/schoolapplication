    ...
    <motion.div className="mx-auto flex flex-col md:flex-row justify-between  rounded-2xl w-full"
      ...
      <motion.div className='p-6'>
       ...
       <motion.h1
        ...
        >Have questions or need assistance? Our team is always ready to help. Whether it’s admissions, inquiries, or support we’d love to hear from you!</motion.h1>
