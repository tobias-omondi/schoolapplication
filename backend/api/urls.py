...
from .views import  StudentViewSet, ClassViewSet, TeacherViewSet , StudentProfileViewSet , PortfolioViewSet , SubjectsViewSet , ParentsViewSet , TcommentsViewSet, NewsViewSet , BlogsViewSet, EventsViewSet
